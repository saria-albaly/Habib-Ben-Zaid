...
<div class="col-md-12" style="text-align: right;direction: rtl;">
  ...
  <h4 style="font-family: 'Janna LT'">قام {{$user->name}} ذو المعرف {{$user->id}} بإرسال تقرير بخطأ غير متوقع:</h4>
  <label style="font-family: 'Janna LT'">توصيف المشكلة:</label><br>
  <label style="font-family: 'Janna LT'">{{$error['url']}}</label><br>
  <p style="font-family: 'Janna LT';text-align: right;direction: rtl;">
    {{$error['dsc']}}
  </p>
  <label style="font-family: 'Janna LT'">دور المستخدم هو :</label>{{$user->role->name}} <br>
  <br>
  <label style="font-family: 'Janna LT'">جميع صلاحيات المستخدم حتى لحظة التقرير</label>:<br>
  <h4 style="font-family: 'Janna LT'">صلاحيات الأقسام:</h4>
    ...
    <h4 style="font-family: 'Janna LT'">صلاحيات المستخدم:</h4>
    <table id="example1" class="table table-bordered table-striped">
      <thead>
      <tr>
        <th style="text-align: right;">#</th>
